  ...
  plugins: [
    ...
    ((plugin, config) => ({
      ...
      addVariant("group-loading", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[loading="true"] .${e(`group-loading${separator}${className}`)}`;
        });
      });
    }),
    // DROPZONE STATE
    ((plugin, config) => ({
      ...
      addVariant("prevented", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.${e(`prevented${separator}${className}`)}[data-prevented="true"]`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("group-prevented", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-prevented="true"] .${e(`group-prevented${separator}${className}`)}`;
        });
      });
    }),
    ((plugin, config) => ({
    ...
    ((plugin, config) => ({
      ...
      addVariant("group-accepted", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-accepted="true"] .${e(`group-accepted${separator}${className}`)}`;
        });
      });
    }),
    // EXPANDED STATE
    ...
    ((plugin, config) => ({
      ...
      addVariant("exiting", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.${e(`exiting${separator}${className}`)}[data-transition="exiting"]`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("entering", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.${e(`entering${separator}${className}`)}[data-transition="entering"]`;
        });
      });
    }),
    ((plugin, config) => ({
    ...
    ((plugin, config) => ({
      ...
      addVariant("group-in", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-transition="in"] .${e(`group-in${separator}${className}`)}`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("group-exiting", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-transition="exiting"] .${e(`group-exiting${separator}${className}`)}`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("group-entering", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-transition="entering"] .${e(`group-entering${separator}${className}`)}`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("group-out", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group[data-transition="out"] .${e(`group-out${separator}${className}`)}`;
        });
      });
    }),
    // FIRST ELEMENT
    ((plugin, config) => ({
      ...
      addVariant("first-element", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.${e(`first-element${separator}${className}`)} > *:first-child`;
        });
      });
    }),
    ((plugin, config) => ({
      ...
      addVariant("group-scoped-hover", ({ modifySelectors, separator }) => {
        modifySelectors(({ className }) => {
          return `.group-scoped:hover > .${e(`group-scoped-hover${separator}${className}`)}`;
        });
      });
    }),
    ((plugin, config) => ({
